...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="newProjectDiv" class="well newProjectSettings non-selectable" runat="server">
        ...
        <div style="text-align:right;">
            ...
            <asp:Button runat="server" ID="moveProjectToTheNextSemester" Visible="false" CssClass="btn btn-default redButton" Text="Ins nächste Semester" OnClientClick="return confirm('Wirklich in das nächste Semester verschieben?');" OnClick="moveProjectToTheNextSemester_Click"></asp:Button>
