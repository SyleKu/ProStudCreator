...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="well usernSettings non-selectable">
        ...
        <ul>
            <li><a href="mailto:markus.oehninger@fhnw.ch">Markus Oehninger</a> für organisatorische Fragen</li>
            <li><a href="mailto:dominik.gruntz@fhnw.ch">Dominik Gruntz</a> für inhaltliche/fachliche Fragen von Projekten am IMVS</li>
            <li><a href="mailto:simon.felix@fhnw.ch">Simon Felix</a> für inhaltliche/fachliche Fragen von Projekten am i4Ds</li>
        </ul>

        <h4>Wer darf Projekte einreichen?</h4>
        <p>Jeder. Externe Auftraggeber (ohne KTI-Projekt) müssen die Arbeiten aber bezahlen (CHF 1500 + MWSt). Externe Auftraggeber besprechen die Projekte am besten mit euch direkt. Für Externe gibt es hier weitere Informationen: <a href="http://www.fhnw.ch/technik/dienstleistung/studierendenprojekte">http://www.fhnw.ch/technik/dienstleistung/studierendenprojekte</a>. U.u. macht es Sinn Industriepartner jetzt über diese Möglichkeit zu informieren. Achtet darauf, dass nicht nur einfache Programmierarbeiten an die Studierenden ausgelagert werden. Es gelten für diese Projekte dieselben Anforderungen wie für interne Projekte.</p>
        <h4>Was passiert, nachdem ich ein Projekt eingereicht habe?</h4>
        <p>Das Projekt wird geprüft und dann entweder veröffentlicht oder zurückgewiesen. Für Erst-Projekt-Einreicher empfiehlt es sich, genügend Zeit für einige Iterationen einzuplanen.</p>
        <h4>Wer betreut die Durchführung der Projekte?</h4>
        <p>
            Als Betreuer kommen alle Dozierenden am i4Ds (z.B. Manfred, André, Doris, Sarah, Ruedi, Stefan, Simon, …) in Frage. Es besteht aber häufig auch die Möglichkeit in einem 2er-Team (z.B. Dozierender + WiMi) zu arbeiten. Wer also kein Dozierender ist, aber trotzdem ein Projekt betreuen möchte, kann das im Normalfall nach Absprache mit einem Dozierenden machen. Die Betreuung kann man aufteilen, die Gesamtverantwortung bleibt beim Dozierenden.
        </p>
        ...
        <p>Geradlinige Arbeiten sind *nicht* geeignet. Es darf nicht von vornherein klar sein, wie man ein Aufgabe lösen kann. Nur das Ziel der Arbeit soll klar definiert sein. Achtet darauf, dass die Aufgabenstellung eine gewisse intellektuelle Flughöhe erreicht, aber gegen oben nicht begrenzt ist. Eine ideale Arbeit enthält einen kleinen, offenen Teil, worin sich die Studierenden austoben können.
            </p>
        <h4>Welche Themen können in einem IP5/IP6 behandelt werden?</h4>
        <p>
            Idealerweise stammen die Aufgabenstellungen aus Industrie- oder Forschungsprojekten der Institute. Für externe Projekte gilt diese Einschränkung nicht.
        </p>
        <h4>Welchen Arbeitsumfang hat ein IP5/IP6?</h4>
        <ul>
            <li>IP5: 2 Studierende à 180h</li>
            <li>IP6: 2 Studierende à 360h</li>
        </ul>
        <p>
